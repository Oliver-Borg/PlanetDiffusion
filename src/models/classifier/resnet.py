...
# ResNet architecture adapted from https://github.com/pytorch/vision/blob/main/torchvision/models/resnet.py
...
class ResNet(nn.Module):
    ...
    def __init__(
        ...
        self.conv1 = nn.Conv2d(img_channels, self.inplanes, kernel_size=7, stride=2, padding=3,
                               bias=False)
