...
# EfficientNet architecture adapted from https://github.com/pytorch/vision/blob/main/torchvision/models/efficientnet.py
...
class EfficientNet(nn.Module):
    def __init__(
        ...
        **kwargs: Any,
        ...
        layers.append(
            Conv2dNormActivation(
                img_channels, firstconv_output_channels, kernel_size=3, stride=2, norm_layer=norm_layer, activation_layer=nn.SiLU
            )
        )
